...
arg.add_argument('-b', help="Boundary Conditon Data Source", type=str, default='ERA5')
...
param_ids = [8, 4, 2, 2, 5, 3]

wrf_sim = WRFModel(param_ids, start_date, end_date,
                   bc_data=bc_data, n_domains=n_domains, setup_yaml=setup_yaml, wfp=False)
