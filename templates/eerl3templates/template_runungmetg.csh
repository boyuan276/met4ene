...
#SBATCH -o /mnt/Bo_HDD/wrf_data/met4ene/wrfout/logs/output.metgrid.%j	# Name of stdout output file(%j expands to jobId)
#SBATCH -e /mnt/Bo_HDD/wrf_data/met4ene/wrfout/logs/errors.metgrid.%j	# Name of stderr output file(%j expands to jobId)
